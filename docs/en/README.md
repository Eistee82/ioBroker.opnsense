...
Monitor your OPNsense firewall from ioBroker. This adapter uses the OPNsense REST API to read gateway status, interface traffic speeds, service states, firmware information, and the ARP table.
